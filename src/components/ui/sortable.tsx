...
/**
 * Sortable Component - Based on DiceUI/sortable
 * @see https://diceui.com/docs/components/sortable
 *
...
const SortableItem = React.forwardRef<HTMLDivElement, SortableItemProps>(
  (props, ref) => {
    const { value, style, asHandle, asChild, disabled, className, ...itemProps } =
      props;
