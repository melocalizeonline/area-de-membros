            ...
            {step === "email" ? (
              <>
                ...
                <form onSubmit={emailForm.handleSubmit(handlePasswordLogin)} className="space-y-4">
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full h-11 text-sm font-semibold flex items-center justify-center gap-2 disabled:opacity-50 transition-opacity focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#1E84FF] focus-visible:ring-offset-2 focus-visible:ring-offset-transparent"
                ...
                <button
                  ...
                  className="w-full h-11 text-sm font-semibold flex items-center justify-center gap-2 disabled:opacity-50 transition-opacity border focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#1E84FF] focus-visible:ring-offset-2 focus-visible:ring-offset-transparent"
                ...
                <button
                  ...
                  disabled={loading}
                  className="w-full h-11 rounded-lg text-sm font-medium flex items-center justify-center gap-2 transition-opacity hover:opacity-80 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#1E84FF] focus-visible:ring-offset-2 focus-visible:ring-offset-transparent"
                  style={{ color: themeColors.textSecondary }}
                >
              ...
              <div className="space-y-6 text-center" role="status" aria-live="polite">
                <div
                  ...
                  style={{ background: themeColors.inputBg }}
                >
                  <Mail className="size-7" style={{ color: buttonColor }} aria-hidden="true" />
                </div>
