-- ============================================================
-- 1. Rename column external_customer_id → external_id
-- 2. Remove document_type validation from update_tenant_customer
-- 3. Update run_customer_csv_import to use external_id
-- ============================================================

-- ─── 1. Rename column ─────────────────────────────────────────
ALTER TABLE public.customers
  RENAME COLUMN external_customer_id TO external_id;

-- Index is automatically updated by Postgres on column rename.

-- ─── 2. Recreate update_tenant_customer without document_type validation ──
...
-- ─── 3. Recreate run_customer_csv_import with external_id ─────
