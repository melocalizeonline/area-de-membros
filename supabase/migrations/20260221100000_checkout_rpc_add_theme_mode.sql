-- ============================================================
-- Add theme_mode to get_public_checkout RPC
--
-- The admin Design page allows setting theme_mode (light/dark)
-- but the public checkout RPC was not returning it, so the
-- checkout page always rendered with a light background.
-- ============================================================
