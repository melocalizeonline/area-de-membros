-- ============================================================
-- Global Search v3 fix — Remove global LIMIT 10
-- ============================================================
-- The previous v3 had ORDER BY cat_order LIMIT 10 which could
-- cut customer/order results when course/lesson/product fill up.
-- Now: 5 per category, no global cap.
-- ============================================================
