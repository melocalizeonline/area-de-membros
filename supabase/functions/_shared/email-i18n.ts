...
const ptBR: EmailTranslations = {
  ...
  signup: {
    subject: "Confirme seu email — Nory Members",
    body: "Obrigado por criar sua conta na Nory Members. Clique no botão abaixo para confirmar seu email e começar a usar a plataforma.",
    cta: "Confirmar email",
  },
  recovery: {
    subject: "Redefinir sua senha — Nory Members",
    body: "Recebemos uma solicitação para redefinir a senha da sua conta. Clique no botão abaixo para criar uma nova senha.",
    cta: "Redefinir senha",
  },
  emailChange: {
    subject: "Confirme seu novo email — Nory Members",
  ...
  magicLink: {
    subject: "Seu link de acesso — Nory Members",
  ...
  creatorWelcome: {
    subject: "Confirme seu cadastro — Nory Members",
...
const en: EmailTranslations = {
  ...
  signup: {
    subject: "Confirm your email — Nory Members",
    body: "Thank you for creating your Nory Members account. Click the button below to confirm your email and get started.",
    cta: "Confirm email",
  },
  recovery: {
    subject: "Reset your password — Nory Members",
    body: "We received a request to reset your account password. Click the button below to create a new password.",
    cta: "Reset password",
  },
  emailChange: {
    subject: "Confirm your new email — Nory Members",
    body: "We received a request to change your account email. Click the button below to confirm.",
    cta: "Confirm new email",
  },
  magicLink: {
    subject: "Your access link — Nory Members",
  ...
  creatorWelcome: {
    subject: "Confirm your sign-up — Nory Members",
...
const es: EmailTranslations = {
  ...
  signup: {
    subject: "Confirma tu email — Nory Members",
    body: "Gracias por crear tu cuenta en Nory Members. Haz clic en el botón de abajo para confirmar tu email y comenzar a usar la plataforma.",
    cta: "Confirmar email",
  },
  recovery: {
    subject: "Restablecer tu contraseña — Nory Members",
  ...
  emailChange: {
    subject: "Confirma tu nuevo email — Nory Members",
  ...
  magicLink: {
    subject: "Tu enlace de acceso — Nory Members",
  ...
  creatorWelcome: {
    subject: "Confirma tu registro — Nory Members",
