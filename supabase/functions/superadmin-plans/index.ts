...
const EDITABLE_FIELDS = ["name", "description", "price_cents", "currency", "is_active", "features", "limits", "sort_order", "plan_type", "trial_days", "checkout_url"] as const;
    ...
    switch (action) {
      case "list_plans": {
        const { data, error } = await admin
          .from("platform_plans")
          .select("id, key, name, description, price_cents, currency, is_active, sort_order, plan_type, trial_days, checkout_url, features, limits, updated_at")
          .order("sort_order");
